...
"background-color: rgb(0, 0, 0);"));
    ...
    void retranslateUi(QMainWindow *SpriteEditorWindow)
    {
        ...
        addFrameButton->setText(QApplication::translate("SpriteEditorWindow", "Add", Q_NULLPTR));
        removeFrameButton->setText(QApplication::translate("SpriteEditorWindow", "Remove", Q_NULLPTR));
        penButton->setText(QApplication::translate("SpriteEditorWindow", "Pen", Q_NULLPTR));
        eraserButton->setText(QApplication::translate("SpriteEditorWindow", "Eraser", Q_NULLPTR));
        selectionButton->setText(QApplication::translate("SpriteEditorWindow", "Selection", Q_NULLPTR));
        duplicateButton->setText(QApplication::translate("SpriteEditorWindow", "Duplicate", Q_NULLPTR));
        framesListLabel->setText(QApplication::translate("SpriteEditorWindow", "Frames", Q_NULLPTR));
        drawMirrorCheckBox->setText(QApplication::translate("SpriteEditorWindow", "Draw Mirrored", Q_NULLPTR));
        frameRateLabel->setText(QApplication::translate("SpriteEditorWindow", "Frame Rate (fps)", Q_NULLPTR));
        popOutButton->setText(QApplication::translate("SpriteEditorWindow", "Full Size Preview", Q_NULLPTR));
    } // retranslateUi
